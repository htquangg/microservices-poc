...
const (
	CustomerService_RegisterCustomer_FullMethodName = "/customerpb.CustomerService/RegisterCustomer"
)
...
func (c *customerServiceClient) RegisterCustomer(ctx context.Context, in *RegisterCustomerRequest, opts ...grpc.CallOption) (*RegisterCustomerResponse, error) {
	...
	err := c.cc.Invoke(ctx, CustomerService_RegisterCustomer_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
